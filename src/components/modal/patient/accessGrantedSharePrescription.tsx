...
const AccessGrantedSharePrescriptionModal = ({
  container,
  title,
}: {
  ...
  return (
    <Modal
      open={isAccessGrantedPrescriptionModalOpen}
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="lg:my-2 text-[10px] lg:text-base">
                You have successfully shared your prescription to Pharm Nicci
                Troiani
              </p>
            </div>
...
export default AccessGrantedSharePrescriptionModal;

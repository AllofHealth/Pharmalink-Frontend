...
import { toggleInstitutionAccessDeniedModal } from "@/lib/redux/slices/modals/modalSlice";
import Image from "next/image";

const InstitutionAccessDeniedModal = ({
  container,
  title,
}: {
  ...
  const isAccessDeniedModalOpen = useSelector(
    (state: RootState) => state.modal.isInstitutionAccessDeniedModalOpen
  );
  ...
  return (
    <Modal open={isAccessDeniedModalOpen} onOpenChange={handleToggleModal}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="lg:my-2 text-[10px] lg:text-base">
                Pharm Nicci Tolani has been denied access to your institution
...
export default InstitutionAccessDeniedModal;

...
import { toggleAcceptAdminModal } from "@/lib/redux/slices/modals/modalSlice";
...
const AcceptAdmin = ({
  ...
  return (
    <Modal open={isAcceptAdminModalOpen} onOpenChange={handleToggleModal}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="lg:my-2 text-[10px] lg:text-base">
                You have successfully made Nicci Troaini a system admin
              </p>
            </div>

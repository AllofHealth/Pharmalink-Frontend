...
import InstitutionBlockChainSignUpForm from "@/page_components/institutionSignup/institutionBlockChainSignUpForm";
import Image from "next/image";

export default function InstitutionBlockChainSignUp() {
  return (
    <div className="flex">
      <Image
      ...
      <section className="min-h-screen xl:min-w-auto flex flex-col justify-center items-center flex-1">
        ...
        <div>
          ...
          <InstitutionBlockChainSignUpForm />
        </div>
      </section>
    </div>
  );

      ...
      <div className="w-[330px] grid gap-6 sm:w-auto lg:grid-cols-3 sm:grid-cols-2">
        <article className="shadow-sm bg-white rounded-[20px] p-6">
          ...
          <p className="font-normal text-gray-2">
            Search health facilities around you. Explore trusted hospitals,
            pharmacies, medical laboratories, gyms near you.
          </p>
        </article>
        <article className="shadow-sm bg-white rounded-[20px] p-6">
          <Icon name="Drugs" />
        ...
        <article className="shadow-sm bg-white rounded-[20px] p-6">
          ...
          <p className="font-normal text-gray-2">
            Health data management. Save, share and track medical history and
            health data
          </p>
        </article>
      </div>

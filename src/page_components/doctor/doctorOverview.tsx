    ...
    <section>
        ...
        <div className="py-4 pr-2 h-max lg:pt-10">
          ...
          <div className="lg:flex lg:gap-4 ">
            <div className="bg-blue5 px-4 py-2 lg:py-4 rounded-2xl mb-4 lg:mb-0">
              ...
              <span className="text-[20px] lg:text-4xl">YongiDuu Hospital</span>
            </div>
            <div className="bg-blue5 px-4 py-2 lg:py-4 rounded-2xl mb-4 lg:mb-0">
              ...
              <span className="text-[20px] lg:text-4xl">Pending</span>
            </div>
          </div>
        </div>
        <Image
      ...
      <div>
        <span className="flex justify-between mb-6">
          <h3 className="text-[18px] lg:text-xl font-bold">Recent Approvals</h3>
        ...
        <div className="flex gap-4 items-center mb-4">
          ...
          />
          <div>
            <h4 className="text-sm lg:text-lg font-medium">Adewale Dele</h4>
            <p className="text-[10px] lg:text-base font-normal">12th April</p>
          </div>
        </div>
        <div className="flex gap-4 items-center mb-4">
          <Image
